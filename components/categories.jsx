...
export default function Categories() {
    return (
        <section className='pt-24 px-5 md:px-0 md:pl-14 md:mr-14 basis-1/2 font-semibold' id='categories'>
            <h2 className='text-3xl mb-5 text-deepBlue font-normal'>CATEGORIES</h2>
            <ul>
